    ...
    <div style={{ width: '100%', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#0C789C' }}>
      <div style={{ width: '100%', maxWidth: 325, position: 'relative', background: 'white', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25) inset', borderRadius: 20, padding: 20 }}>
        <div style={{ textAlign: 'center', marginBottom: 15 }}>
          ...
          <h2 style={{ marginTop: -70, fontSize: 24, fontFamily: 'Roboto'}}>Inicio Sesión</h2>
        </div>
        <div style={{ marginBottom: 20 }}>
          <label htmlFor="userId" style={{ display: 'block', marginBottom: 15, fontFamily: 'Roboto'}}>Id del usuario:</label>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ marginTop: 15 }}>
              ...
              <label style={{ fontFamily: 'Roboto'}}htmlFor="showPassword">Mostrar contraseña</label>
            </div>
          </div>
        </div>
        <button type="submit" disabled={!userId || !password} style={{ width: '50%', height: 40, background: '#047393', color: 'white', fontSize: '16', borderRadius: 9, border: 'none', margin: 'auto', marginTop: 30, cursor: 'pointer', display: 'block', fontFamily: 'Roboto'}}>Ingresar</button>
      </div>
    </div>
  );
}
